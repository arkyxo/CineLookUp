    ...
    <div className="mx-auto max-w-4xl px-4 pb-16 pt-8 sm:px-8">
      <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-ink/50">A look back at what you've watched and rated.</p>
        </div>
          ...
          {['all', 'year'].map((r) => (
            <button
              ...
              className={`px-4 py-2 text-sm font-medium transition ${
                range === r ? 'bg-crimson-600 text-ink' : 'text-ink/70 hover:bg-ink/10'
              }`}
            >
      ...
      {topDecade && (
        <div className="mt-6 rounded-xl border border-ink/10 bg-card p-6 text-center">
          <p className="text-xs font-semibold uppercase tracking-wide text-ink/50">Favorite Decade</p>
